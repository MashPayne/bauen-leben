...
$GLOBALS['TL_LANG']['tl_webshop_article'] = array(
    ...
    'downloadSRC' => array('Download Datei', 'Bitte wählen Sie eine Datei aus.'),
    'downloadLimited' => array('Download limitieren', 'Wählen Sie diese Option wenn Sie die Anzahl oder den Zeitraum für den Download begrenzen möchten.'),
    'downloadLifetime' => array('Begrenzung nach Tagen', 'Geben Sie einen Wert größer 0 ein um die Anzahl der Tage zu begrenzen in der der Artikel heruntergeladen werden kann.'),
    'downloadCount' => array('Maximale Downloads', 'Geben Sie einen Wert größer 0 ein, um die Anzahl der Downloads zu begrenzen.'),
    ...
    'opValue' => 'Ab Stückzahl',
    'opLabel' => 'Staffelpreis',
    'tabtext' => array('Tabtext', 'Zusätzlich zum normalen Beschreibungstext können Sie hier mehrere Tabs zur Gliederung einbauen.'),
    ...
    'lbl_options' => 'Artikeloptionen',
    'tags' => array('Tags', 'Geben Sie Tags bitte Komma-Getrennt ein.'),
    'html' => array('HTML', 'Geben Sie Ihren HTML-Code ein, um diesen auf der Artikeldetailseite ausgeben zu lassen.'),
    'multiadd' => array('Mehrere Varianten anlegen', 'Mehrere Varianten anlegen'),
    ...
    'allowComment' => array('Kommentar erlauben', 'Ermöglicht es dem Kunden im Warenkorb einen Kommentar zum Artikel zu hinterlegen.')
